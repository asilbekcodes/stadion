    ...
    return (
        <div className="w-64 bg-gray-100 h-screen">
            <nav>
                <ul>
                    <li>
                        <Link to="/sadmin/sadmindashboard" className='flex p-4 active:w-full active:bg-gray-300 hover:w-full hover:bg-gray-300 bg-gray-300 gap-5 font-semibold items-center'><FaTerminal />Dashboard</Link>
                    </li>
                    <li>
