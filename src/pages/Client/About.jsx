...
function About() {
  ...
  return (
    <div className="w-full">
          ...
          <div className="grid md:grid-rows-2 gap-0 md:gap-24">
            <div>
              <div className="flex items-center space-x-2 mb-5">
                ...
                <span className="text-gray-500 text-[16px]">{result.star} </span>
              </div>
              <h2 className="text-2xl md:text-[32px] font-semibold">
                {result.title}
              </h2>
              <p className="text-base flex items-start gap-1 md:text-lg text-gray-500 my-5">
            ...
            <div className="hidden md:block">
              <p className="text-base md:text-[20px] font-bold mb-10">
                Narxi:{" "}
      ...
      <div className="p-3 lg:px-40 md:pt-[80px] md:pb-[100px] bg-white flex flex-col justify-center md:flex-row ">
      ...
      <div className="p-3 lg:px-40 md:py-40 md:gap-20 gap-0 bg-white flex flex-col md:flex-row justify-between">
        <div className="w-full">
          <MapComponent
